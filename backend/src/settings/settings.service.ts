...
export class SettingsService {
  ...
  async update(userId: string, dto: UpdateSettingsDto): Promise<SettingsResponseDto> {
    ...
    const mergedPreferences: NotificationPreferences = dto.notificationPreferences
    ...
    const settings: UserSettings = await this.prisma.userSettings.update({
      ...
      data: {
        ...
        ...(dto.notificationPreferences !== undefined && {
          notificationPreferences: mergedPreferences as unknown as Prisma.InputJsonValue,
        }),
      },
    });
