...
export class SyncResponseDto {
  ...
  @ApiProperty({ description: 'Versión incremental de la última sincronización exitosa', example: 4 })
  syncVersion: number;

  @ApiPropertyOptional({ description: 'Fecha de la última sincronización completada', nullable: true })
